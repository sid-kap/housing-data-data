...
COUNTY_POPULATION_PATHS = [
    ...
    f"https://www2.census.gov/programs-surveys/popest/tables/2000-2010/intercensal/county/co-est00int-01-{state.fips}.csv"
    for state in us.STATES_AND_TERRITORIES
    if state.fips not in ["60", "66", "69", "72", "78"]
] + [
...
def download_population_data():
    for path in STATE_POPULATION_PATHS:
        download_to_directory(path, STATE_POPULATION_ROOT0)
